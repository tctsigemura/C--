...
標準出力ストリームへ１行出力します．
エラー（EOFもエラーの一種）が発生した場合は\|true|を，
正常時には\|false|を返します．
...
文字\|c|がアルファベット小文字なら（'a'〜'z'）\|true|を返します．
...
文字\|c|がアルファベット大文字なら（'A'〜'Z'）\|true|を返します．
...
{\ul}add32 関数は，トランスレータ版では使用できません．
...
{\ul}sub32 関数は，トランスレータ版では使用できません．
...
{\ul}div32 関数は，トランスレータ版では使用できません．
...
{\ul}mod32 関数は，トランスレータ版では使用できません．
